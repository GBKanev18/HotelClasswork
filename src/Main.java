...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("3. Print the names and the price of the particular city. ");
    ...
    public static HotelGuests insertData(Scanner scanner) {
        ...
        System.out.println();
        System.out.print("EGN: "); ucn = scanner.nextLine();
        System.out.println();
    ...
    public static void printHotelGuestsFromParticularCity(ArrayList<HotelGuests> hotelGuests, Scanner sc) {
        ...
        System.out.println("Total price for the beds: " + totalPrice);
    }
